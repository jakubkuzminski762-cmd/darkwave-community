...
Route::view('/design-system','foundation.home')->name('design-system');
...
Route::get('/preview/page/{page}',[PreviewController::class,'page'])->middleware('signed')->name('preview.page');
Route::get('/preview/post/{post}',[PreviewController::class,'post'])->middleware('signed')->name('preview.post');
