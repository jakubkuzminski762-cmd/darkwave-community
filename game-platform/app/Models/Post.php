...
{
    protected $fillable = ['post_category_id','media_id','title','slug','excerpt','body','author_name','status','published_at','reading_minutes','toc','embedded_media','related_game_slug','seo_title','seo_description','og_image_url','canonical_url'];

    protected function casts(): array
    {
        return ['status' => ContentStatus::class, 'published_at' => 'datetime', 'toc' => 'array', 'embedded_media' => 'array'];
    }
