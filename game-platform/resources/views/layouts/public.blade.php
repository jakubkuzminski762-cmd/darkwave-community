...
<body x-data="uiShell" @keydown.escape.window="mobileOpen ? closeMobile() : (modalOpen ? closeModal() : null)">
    ...
    <header class="site-header">
        ...
        <div id="mobile-navigation" class="mobile-menu" x-cloak x-show="mobileOpen" x-transition.opacity>
            <div class="container mobile-menu-inner">
                <div style="display:flex;justify-content:flex-end">
                    <button class="icon-btn" type="button" x-ref="mobileClose" @click="closeMobile()" aria-label="Zamknij menu">×</button>
                </div>
                <nav aria-label="Nawigacja mobilna" style="display:grid;gap:.25rem">
                    <a class="nav-link" href="#games" @click="closeMobile()">Gry</a>
                    <a class="nav-link" href="#components" @click="closeMobile()">Design system</a>
                    <a class="nav-link" href="{{ route('developer.home') }}">Dla deweloperów</a>
